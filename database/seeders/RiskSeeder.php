...
class RiskSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($risksData as $data) {
            ...
            $riskAttributes = collect($data)->except('control')->toArray();

            $risk = Risk::updateOrCreate(
                ['pemilik_risiko' => $riskAttributes['pemilik_risiko']],
                $riskAttributes
            );

            // Attach kontrol ke pivot (idempotent — tidak duplikat jika sudah ada)
