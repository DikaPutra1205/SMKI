...
export default function ComplianceAreaChart({ labels, values }: TrendChartProps) {
    ...
    return (
        <svg className="h-[230px] w-full" viewBox="0 0 640 240" preserveAspectRatio="none" role="img" aria-label="Tren kepatuhan bulanan">
            ...
            <g stroke="#E3E9F0" strokeWidth="1">
                <line x1={40} y1={20} x2={620} y2={20} stroke="#E3E9F0" strokeWidth="1" />
                <line x1={40} y1={75} x2={620} y2={75} stroke="#E3E9F0" strokeWidth="1" />
                <line x1={40} y1={130} x2={620} y2={130} stroke="#E3E9F0" strokeWidth="1" />
                <line x1={40} y1={185} x2={620} y2={185} stroke="#E3E9F0" strokeWidth="1" />
                <line x1={40} y1={20} x2={40} y2={210} stroke="#E3E9F0" strokeWidth="1" />
