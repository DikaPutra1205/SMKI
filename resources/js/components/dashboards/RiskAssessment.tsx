    ...
    return (
        <div className="border-border rounded-[14px] border bg-white shadow-sm">
            <div className="border-border flex items-center justify-between border-b px-5 py-4">
                ...
                <a href={`/admin/kepatuhan/findings?status=${riskRegisterLabel}`} className="text-primary hover:text-primary-700 text-xs font-semibold">
            ...
            <div className="px-5 py-4">
                <div className="flex items-end justify-center gap-8" style={{ height: '150px' }}>
                    {[
                        ...
                        { label: labels?.mitigationInProgress ?? t('status.medium'), value: risks.medium, color: 'linear-gradient(180deg,#F0B45E,#F8DCA6)' },
