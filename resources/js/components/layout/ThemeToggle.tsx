...
export function ThemeToggle({ className }: { className?: string }) {
    ...
    return (
        <button
            ...
            className={`border-border text-body hover:bg-surface hover:text-navy relative flex h-9 w-9 items-center justify-center rounded-[10px] border bg-white shadow-xs transition-transform duration-200 hover:scale-105 focus:ring-2 focus:ring-blue-500/20 focus:outline-none active:scale-95 dark:border-white/10 dark:bg-white/5 dark:text-slate-300 dark:hover:bg-white/10 dark:hover:text-white ${className ?? ''}`}
